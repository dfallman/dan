...
**Dan** is a fast, friendly, and zero fuss terminal text editor. Written natively in **Rust**, it is designed to be modeless, resource-efficient, and zero-latency, even over fluctuating SSH connections. It has been architectured to handle very large files and complex editing tasks, while remaining simple to use and configure. Dan works in most terminal emulator environments, whether you're using macOS, Linux, or Windows.
