...
impl Editor {
	...
	pub fn execute(&mut self, cmd: Command) {
		...
		match cmd {
			...
			Command::MoveLogicalLineStart => self.cmd_move_logical_line_start(),
			Command::MoveLogicalLineEnd => self.cmd_move_logical_line_end(),
			...
			Command::SelectLogicalLineStart => self.cmd_select_logical_line_start(),
			Command::SelectLogicalLineEnd => self.cmd_select_logical_line_end(),
